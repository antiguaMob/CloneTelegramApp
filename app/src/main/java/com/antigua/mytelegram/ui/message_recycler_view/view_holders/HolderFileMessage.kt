...
import com.antigua.mytelegram.utilits.WRITE_FILES
import com.antigua.mytelegram.utilits.asTime
import com.antigua.mytelegram.utilits.checkPermission
...
class HolderFileMessage(view: View): RecyclerView.ViewHolder(view) ,MessageHolder {
    ...
    private val chatUserFileMessageTime: TextView = view.chat_user_file_massage_time
    private val chatReceivedFileMessageTime: TextView = view.chat_received_file_massage_time
